...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{2dcostbenefitexample2.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{2dcostbenefitexample.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{3dcostbenefitexample.png}
...
%
\begin{figure}
\includegraphics[width=1\textwidth]{penaltyfunction.jpg}
...
\end{table}
%
The parameters relative standard deviation is a measure of how much the parameter generalize (a low standard deviation means high level of generalization). The distance score is explained in section \ref{sec:ph1tweaking}, and AUC in section \ref{sec:robustness}.
%
\begin{table}
  \begin{tabular}{| l | p{2.5cm} |p{2.5cm} | p{2.5cm} | c |}\hline
    Label & Parameter(s) std. dev. \% & Distance score (DS) & DS std. dev. \% & AUC \\\hline
...
\begin{figure}
  \centering
    %\includegraphics[scale=0.5]{computeFrameStateAnders\_sectionCompareBetter\_smooth0\_tol24.jpg}
  \caption{caption}
\end{figure}
%
