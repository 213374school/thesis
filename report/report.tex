...
% fixes "too many unprocessed floats" problem
\usepackage{placeins}
...
\title{Automatic video summary from multiple sources with a coherent contextual flow}
...
\appendix
\include{appendix}
\chapter{Cost/Benefit Diagrams}\label{app:cbdia}
