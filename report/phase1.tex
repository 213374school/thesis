...
A final configuration of an algorithm is hence a smoothness degree for smoothing the resulting frame states and a set of parameters, and which method was used to compare this configuration to the gold standard.% the methods described in section \ref{sec:fbfclass} and \ref{sec:tempclass}.
