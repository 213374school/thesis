...
% KIM: + figurer som viser screendump af website
...
% KIM: reference
 ...
 % KIM: skriv specific null-hypotese (til hver tabel)
%
...
\subsection{Analysis}
%
% KIM: husk læseren på hvilke metoder hører til hvilke figurer
...
% The only statistical significance in the Friedman test is \textit{content} in Table \ref{tab:fried_dataset}. As everything else is statistically insignificant we do not pursue further statistical analysis.\\
...
% KIM: + number of answers + number of videos in each category
\\
...
% KIM: hvilken effekt har de tidligere skridt i pipelinen?
%
\section{Summary}
%
% LAUGE
...
%
% KIM: der mangler en diskussion af alle skridt i jeres system. 
