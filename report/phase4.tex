...
\section{Summary}
%
We have described a way to automatically generate video summaries based on a defined \textit{recipe}. We have shown how the structure of this recipe can be used to compensate for some of the shortcomings of the various label classifiers we described in chapter \ref{chapter:groupandlabel}.\\
